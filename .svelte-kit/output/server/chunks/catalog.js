import { b as locales } from "./i18n.js";
const l$2 = (en, zh) => ({ en, "zh-CN": zh });
const tagLabels = {
  random: l$2("random", "随机"),
  generator: l$2("generator", "生成"),
  string: l$2("string", "字符串"),
  hex: l$2("hex", "十六进制"),
  number: l$2("number", "数字"),
  uuid: l$2("uuid", "UUID"),
  password: l$2("password", "密码"),
  security: l$2("security", "安全"),
  id: l$2("id", "标识符"),
  text: l$2("text", "文本"),
  json: l$2("json", "JSON"),
  format: l$2("format", "格式化"),
  yaml: l$2("yaml", "YAML"),
  convert: l$2("convert", "转换"),
  base64: l$2("base64", "Base64"),
  image: l$2("image", "图片"),
  url: l$2("url", "网址"),
  encode: l$2("encode", "编码"),
  html: l$2("html", "HTML"),
  hash: l$2("hash", "哈希"),
  md5: l$2("md5", "MD5"),
  sha: l$2("sha", "SHA"),
  ...
  case: l$2("case", "大小写"),
  radix: l$2("radix", "进制"),
  binary: l$2("binary", "二进制"),
  chinese: l$2("chinese", "中国"),
  identity: l$2("identity", "证件号"),
  csv: l$2("csv", "CSV"),
  unicode: l$2("unicode", "Unicode"),
  inspect: l$2("inspect", "解析"),
  statistics: l$2("statistics", "统计"),
  lines: l$2("lines", "行处理"),
  slug: l$2("slug", "短链名"),
  base32: l$2("base32", "Base32"),
  http: l$2("http", "HTTP"),
  status: l$2("status", "状态码"),
  xml: l$2("xml", "XML")
};
const baseToolTags = {
...
function tagLabel(tag, locale) {
  return tagLabels[tag]?.[locale] ?? tag;
}
function matchesTag(tag, needle) {
  const value = needle.toLocaleLowerCase().replace(/^#/, "");
  return tag.toLocaleLowerCase().includes(value) || Object.values(tagLabels[tag] ?? {}).some((label) => label.toLocaleLowerCase().includes(value));
}
const l$1 = (en, zh) => ({ en, "zh-CN": zh });
const meta = ({ steps, ...details }) => ({
  ...details,
...
const extraTools = [
  meta({
    ...
    category: "convert",
    icon: "Image",
    name: l$1("Image ↔ Base64", "图片与 Base64 转换"),
    description: l$1(
  ...
  meta({
    ...
    category: "convert",
    icon: "Binary",
    name: l$1("Base / radix converter", "进制转换"),
    description: l$1(
  ...
  meta({
    ...
    category: "generate",
    icon: "IdCard",
    name: l$1("Chinese ID test data", "中国身份证号测试数据"),
    description: l$1(
  ...
  meta({
    ...
    category: "convert",
    icon: "Table",
    name: l$1("CSV ↔ JSON", "CSV 与 JSON 转换"),
    description: l$1(
  ...
  meta({
    ...
    category: "text",
    icon: "Languages",
    name: l$1("Unicode inspector", "Unicode 字符检查"),
    description: l$1(
    ...
    example: l$1("中 is U+4E2D and UTF-8 E4 B8 AD.", "“中”的码位是 U+4E2D，UTF-8 字节为 E4 B8 AD。"),
    steps: {
  ...
  meta({
    ...
    category: "other",
    icon: "Link",
    name: l$1("URL inspector", "URL 解析器"),
    description: l$1(
  ...
  meta({
    ...
    category: "text",
    icon: "ListFilter",
    name: l$1("Line sorter & deduplicator", "文本行排序与去重"),
    description: l$1(
  ...
  meta({
    ...
    category: "text",
    icon: "Link2",
    name: l$1("URL slug generator", "URL Slug 生成器"),
    description: l$1(
    ...
    example: l$1("Hello, World! becomes hello-world.", "Hello, World! 会变为 hello-world。"),
    steps: {
      en: [
  ...
  meta({
    ...
    category: "convert",
    icon: "Binary",
    name: l$1("Base32 encoder / decoder", "Base32 编码与解码"),
    description: l$1(
    ...
    example: l$1("foo becomes MZXW6===.", "foo 编码后为 MZXW6===。"),
    steps: {
  ...
  meta({
    ...
    category: "other",
    icon: "Globe",
    name: l$1("HTTP status lookup", "HTTP 状态码速查"),
    description: l$1(
  ...
  meta({
    ...
    category: "text",
    icon: "FileCode2",
    name: l$1("XML validator & formatter", "XML 校验与格式化"),
    description: l$1(
